...
public class UserService implements UserDetailsService {
    ...
    public ResponseObjectService findAllByFirstName(String firstName){
        ResponseObjectService responseObj = new ResponseObjectService();
//        Optional<UserEntity> optUser = userRepo.findAllByFirstName(firstName);
//        System.out.println(optUser);
//        if (optUser.isEmpty()) {
//            responseObj.setStatus("fail");
//            responseObj.setMessage("user name: " + firstName + " not existed");
//            responseObj.setPayload(null);
//            return responseObj;
//        } else {
//
//            responseObj.setPayload(optUser);
//            responseObj.setStatus("success");
//            responseObj.setMessage("success");
//            return responseObj;
//        }
        try {
            responseObj.setPayload(userRepo.findAllByFirstName(firstName));
            responseObj.setStatus("success");
            responseObj.setMessage("success");
        } catch (Exception e){
